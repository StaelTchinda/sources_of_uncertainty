...
def get_default_lightning_module_params() -> Dict[Text, Any]:
    return {
        ...
        "train_metrics": metrics_config.get_default_deterministic_train_metrics(num_classes=182),
        "val_metrics": metrics_config.get_default_deterministic_val_metrics(num_classes=182)
    }
