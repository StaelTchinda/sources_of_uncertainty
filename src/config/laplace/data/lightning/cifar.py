...
from config.data.lightning import cifar as cifar_config

def get_default_dataset_params(dataset_mode: DatasetMode):
    return cifar_config.get_default_dataset_params(dataset_mode)
...
def get_default_datamodule_params():
    return {
        **cifar_config.get_default_datamodule_params(),
